...
class TestClinicianCalendar_ManualOptimize_PreferenceCheck:
    ...
    def test_ClinicianCalendarManualOptimizePreferenceCheck_page(self, get_test_data):
        ...
        ManualOptimizeRoute(driver).OptimizeRoute_Prefer_Visit_RoutePreference_VisitClient(get_test_data)
